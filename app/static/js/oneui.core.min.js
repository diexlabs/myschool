...
!(function (e, t) {
  ...
  var p = (function (n) {
    ...
    return (
      ...
      (d.sortStable = C.split("").sort(N).join("") === C),
        ...
        (U.show = function () {
          ...
          if (
            ...
            if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
              ...
              p(this._element)
                .one(g.TRANSITION_END, function () {
                  p(n._element).removeClass(ee).addClass(Z).addClass(J),
                    (n._element.style[r] = ""),
          ...
          if (!this._isTransitioning && p(this._element).hasClass(J)) {
            ...
            if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
              ...
              (this._element.style[n] =
                ...
                p(this._element).addClass(ee).removeClass(Z).removeClass(J);
                ...
                for (var r = 0; r < i; r++) {
                  ...
                  null !== s &&
                    (p([].slice.call(document.querySelectorAll(s))).hasClass(
                      ...
                      p(o).addClass(te).attr("aria-expanded", !1));
                }
              ...
              p(this._element)
                .one(g.TRANSITION_END, function () {
                  e.setTransitioning(!1),
                    p(e._element).removeClass(ee).addClass(Z).trigger(G.HIDDEN);
                })
          ...
          if (
            ...
            if ((p(i).trigger(n), !n.isDefaultPrevented())) {
              ...
              "ontouchstart" in document.documentElement &&
                ...
                p(i).toggleClass(ct).trigger(p.Event(at.SHOWN, t));
            }
          }
        }),
        (et.hide = function () {
          if (
            ...
            p(n).trigger(t),
              t.isDefaultPrevented() ||
                ...
                p(this._menu).toggleClass(ct),
                p(n).toggleClass(ct).trigger(p.Event(at.HIDDEN, e)));
          }
        }),
        (et.dispose = function () {
                ...
                if (
                  ...
                  p(r).trigger(l),
                    l.isDefaultPrevented() ||
                      ...
                      p(a).removeClass(ct),
                      p(r).removeClass(ct).trigger(p.Event(at.HIDDEN, s)));
                }
              }
            }
        }),
      ...
      Sn =
        ...
        (dn._activate = function (t) {
          ...
          n.hasClass("dropdown-item")
            ? (n.closest(".dropdown").find(".dropdown-toggle").addClass(En),
              n.addClass(En))
            : (n.addClass(En),
              n
                .parents(wn)
                .prev(xn + ", " + Tn)
                .addClass(En),
              n.parents(wn).prev(".nav-item").children(xn).addClass(En)),
          ...
          (this.onPointerEvent = function (e) {
            ...
            (a.axis.x.track.rect = a.axis.x.track.el.getBoundingClientRect()),
              ...
              (t || n) &&
                ...
                "mousedown" === e.type &&
                  (t &&
                    ((a.axis.x.scrollbar.rect =
                      a.axis.x.scrollbar.el.getBoundingClientRect()),
                    a.isWithinBounds(a.axis.x.scrollbar.rect)
                      ? a.onDragStart(e, "x")
                      : a.onTrackClick(e, "x")),
                  n &&
                    ((a.axis.y.scrollbar.rect =
                      a.axis.y.scrollbar.el.getBoundingClientRect()),
      ...
      return (
        ...
        (e.onTrackClick = function (e, i) {
          ...
          if ((void 0 === i && (i = "y"), this.options.clickOnTrack)) {
            var o = Vr(this.el);
            this.axis[i].scrollbar.rect =
              this.axis[i].scrollbar.el.getBoundingClientRect();
